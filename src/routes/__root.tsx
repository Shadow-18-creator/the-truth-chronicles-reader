...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "dark fantasy webnovel, psychological trauma, geopolitical thriller, mythology meets cyberpunk, action novel, reader community interaction enabled" },
      { property: "og:title", content: "The Boy Who Saw The Truth — Read the Novel" },
      { property: "og:description", content: "dark fantasy webnovel, psychological trauma, geopolitical thriller, mythology meets cyberpunk, action novel, reader community interaction enabled" },
