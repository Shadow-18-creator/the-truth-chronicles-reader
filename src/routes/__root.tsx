...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "grim dark fantasy novel, action novel, mythology meets cyberpunk, geopolitical tension, psychological trauma,, free serialised web novel,onlinefiction community" },
      { property: "og:title", content: "The Boy Who Saw The Truth — Read the Novel" },
      { property: "og:description", content: "grim dark fantasy novel, action novel, mythology meets cyberpunk, geopolitical tension, psychological trauma,, free serialised web novel,onlinefiction community" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "The Boy Who Saw The Truth — Read the Novel" },
      { name: "twitter:description", content: "grim dark fantasy novel, action novel, mythology meets cyberpunk, geopolitical tension, psychological trauma,, free serialised web novel,onlinefiction community" },
