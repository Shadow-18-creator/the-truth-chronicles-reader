...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      { title: "Scriptorium — The Boy Who Saw The Truth" },
      { name: "description", content: "Admin scriptorium for publishing and managing chapters of The Boy Who Saw The Truth." },
